...
A ros2_control layer implementation for Maxon EPOS actuator drivers. See [layered_hardware](https://github.com/yoshito-n-students/layered_hardware/tree/humble) to understand the layered scheme.
